...
const generar = () => {
  let seleccion = caracteres.toString();
  if (doceCaracteres.checked) {
    for (let i = 0; i < parseInt(doceCaracteres.value); i++) {
      password += seleccion[Math.floor(Math.random() * seleccion.length)];
    }
    return password;
...
doceCaracteres.addEventListener("click", () => {
  btnGenerador.addEventListener("click", () => {
    password = " ";
    generar();
    document.querySelector(".input-generador").value = password;
  });
});

seisCaracteres.addEventListener("click", () => {
  btnGenerador.addEventListener("click", () => {
    password = " ";
    generar();
    document.querySelector(".input-generador").value = password;
...
nueveCaracteres.addEventListener("click", () => {
  btnGenerador.addEventListener("click", () => {
    password = " ";
    generar();
    document.querySelector(".input-generador").value = password;
...
btnReGenerador.addEventListener("click", () => {
  if (doceCaracteres.checked) {
    password = " ";
    generar();
    document.querySelector(".input-generador").value = password;
